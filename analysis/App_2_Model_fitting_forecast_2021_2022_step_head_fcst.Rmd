...
subtitle: 2021 - 2022 Skagit River steelhead forecast.
output:
  pdf_document:
    toc: yes
    toc_depth: '3'
...
# Model Averaging and 2021 - 2022 forecast
Here is weighted average forecast for 2021 - 2022 based on the model LFOIC weights. We
also compare predictions for return years 2011 - 2021 generated from each of the
six models evaluated including an ensemble (weighted) to observed run size.

```{r }
## extract median 2021 forecast from each model
f_dat<-data.frame(
...
model_selection[,"2021_forecast"] <- apply(f_dat,2,median)

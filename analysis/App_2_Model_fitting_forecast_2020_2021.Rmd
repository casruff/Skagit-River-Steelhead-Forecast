...
write.csv(summary_stats1,file.path(savedir,"Summary_stats_AR.csv"),row.names = F)
...
write.csv(summary_stats2,file.path(savedir,"Summary_stats_AR1_MA1.csv"),row.names = F)
```

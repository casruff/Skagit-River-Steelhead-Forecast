...
# p_dat_AR1MA1 <- p_dat_AR1MA1 + matrix(dat_harv, length(CI_vec), n_yrs+n_fore, byrow = TRUE)
# 
# p_dat_AR1 <- mod_res_AR1[,grep("Sp", colnames(mod_res_AR1))]
# 
# p_dat_AR1 <- apply(p_dat_AR1, 2, quantile, CI_vec)
# p_dat_AR1 <- p_dat_AR1 + matrix(dat_harv, length(CI_vec), n_yrs+n_fore, byrow = TRUE)

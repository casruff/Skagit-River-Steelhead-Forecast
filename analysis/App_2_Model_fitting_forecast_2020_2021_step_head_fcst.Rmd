...
weighted_forecast_quantiles<-quantile(weighted_forecast,c(0.025,0.25,0.50,0.75,0.975))
...
points(x=1:n_forecasts,y=obs_trs,col="black",cex=1.5,pch=20)
legend("topright",legend=c(models,"Observed"),lty=c(1:3,NA),col="black",lwd=2,pch=c(NA,NA,NA,20),bty="n")
```

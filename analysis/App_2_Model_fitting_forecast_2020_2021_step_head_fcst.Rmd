...
Model Selection Via `loo()` and `compare()` with full table of results. Note that `elpd_diff` will be negative (positive) if the expected predictive accuracy for the first (second) model is higher.
...
Sdat<-RSdat(var="Sp",yrs=c(1:(n_yrs+n_fore-3)))

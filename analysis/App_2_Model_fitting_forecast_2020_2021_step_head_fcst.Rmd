...
LFO1<-approx_LFO(N=N,L=L,m=1,esc_only=esc_only,mod_fits=mod_fits,userefits="Yes",refitname="BH_cov_MA1_AR1",thres=thres)
# plot_ks(LFO1$ks,N=N,L=L,thres=thres)
# plot_ks(LFO1$k_LOOIC,N=N,L=L,thres=thres)

LFO2<-approx_LFO(N=N,L=L,m=2,esc_only=esc_only,mod_fits=mod_fits,userefits="Yes",refitname="BH_cov_AR",thres=thres)
# plot_ks(LFO2$ks, N=N,L=L,thres=thres)
# plot_ks(LFO2$k_LOOIC, N=N,L=L,thres=thres)

LFO3<-approx_LFO(N=N,L=L,m=3,esc_only=esc_only,mod_fits=mod_fits,userefits="Yes",refitname="BH_cov_AR_resid",thres=thres)
